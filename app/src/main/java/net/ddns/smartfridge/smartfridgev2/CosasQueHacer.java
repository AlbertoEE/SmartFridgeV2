...
public class CosasQueHacer {
    //TODO Revisar pila de actividades en dialogActivity, cierra la transparente y vuelve a la anterior, linea 525 -ALBERTO-

    //TODO mirar por qué se va hacia un fragment cuando sale el dialog de alimento preparado para incluirlo en
    //la lista de la compra, en lugar de quedarse donde estaba -ALBERTO-
    ...
    //2.TODO Borrar elementos de la lista -ALBERTO- HECHO
    //3.TODO Modificar elementos de la lista -ALBERTO- HECHO
    7.TODO Abrir una lista cuando se pulse en ella -RAQUEL Y ALBERTO-
    //9.TODO poner título a la lista de alimentos: "Seleccionelos alimentos que quiere eliminar a la lista de la compra" o algo similar "definicion explicativa" "SUGERIDOS" -ALBERTO- HECHO
    ...
    //11.TODO Solucionar NullPointer en NuevaListaActivity línea 251, cuando salen las sugerencias y se da para atrás sin seleccionar nada -ALBERTO CREO QUE ESTA SOLUCIONADO- HECHO
    12.TODO organizar los productos de la lista via nombre -ALBERTO TODAS LAS LISTAS ORGANIZAR-
    //13.TODO Mirar por qué cuando no se selecciona nada de lo sugerido, se agrega a la lista HECHO
